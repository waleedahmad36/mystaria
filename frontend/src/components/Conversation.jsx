...
// 				})
// 			}
// 			bg={isSelected ? (colorMode === "light" ? "gray.200" : "gray.dark") : ""}
// 			borderRadius={"md"}
// 		>
// 			<WrapItem>
// 				<Avatar
...
// 						<Box color={isSelected ? "blue.400" : lastMessage.seen ? "blue.400" : ""}>
// 							<BsCheck2All size={16} />
// 						</Box>
// 					)}
// 					{lastMessage.text ? (
...
const Conversation = ({ conversation, isOnline }) => {
    ...
    }, [socket, conversation._id, setConversations]);
    ...
    return (
        <Flex
            ...
            bg={isSelected ? (colorMode === "light" ? "gray.200" : "gray.900") : ""}
            borderRadius={"md"}
        >
            <WrapItem>
