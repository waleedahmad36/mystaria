...
const CreatePost = () => {
	...
	const handleCreatePost = async () => {
		...
		try {
			...
			showToast("Success", "Post submited please wait for admin approvals", "success");
	...
	return (
		...
		{user.username === username && (
			...
			right={5}
			bg={{
				base:useColorModeValue("gray.300", "gray.900"),
				md:useColorModeValue("gray.300", theme)
			}}
			onClick={onOpen}
			size={{ base: "xs", sm: "md" }}
		>
			...
			<Modal isOpen={isOpen} onClose={onClose}   >
				...
				maxW={{ base: "90%", sm: "70%", md: "60%", lg: "53%" }}   >
