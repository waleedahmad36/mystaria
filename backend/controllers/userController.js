...
const updateUsers = async () => {
	try {
	  // Update all existing users to have the isBlocked field with a default value of false
	  await User.updateMany({}, { $set: { isBlocked: false } });
  
	  console.log('All users have been updated with the isBlocked field');
	} catch (error) {
